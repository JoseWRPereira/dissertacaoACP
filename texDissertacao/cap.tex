...
\folhaderosto
\fichacatalografica
%\input{./texDissertacao/fichaCatalografica}

\folhadeaprovacao

\dedicatoria{\input{./texDissertacao/dedicatoria}}
\agradecimentos{\input{./texDissertacao/agradecimentos}}
\epigrafe{\input{./texDissertacao/epigrafe}}
\resumo{\input{./texDissertacao/resumo}}
\resumolinguaestrangeira{\input{./texDissertacao/abstract}}
\listadefiguras
\listadetabelas
\listadeabreviaturasesiglas

\chapter*{Lista de símbolos}
\input{./texDissertacao/simbolos}
...
\input{./texDissertacao/cap1-objetivo}

\chapter[RevisãoBibliográfica]{2. Revisão Bibliográfica}
\input{./texDissertacao/cap2-revBib}

\chapter[Desenvolvimento]{3. Desenvolvimento}
\input{./texDissertacao/cap3-desen}

\chapter[Materiais e Métodos]{4. Materiais e Métodos}
\input{./texDissertacao/cap4-metodologia}

\chapter[Resultados]{5. Resultados}
\input{./texDissertacao/cap5-resultados}

\chapter[Conclusão]{6. Conclusão}
\input{./texDissertacao/cap6-conclusao}
